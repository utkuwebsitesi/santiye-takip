...
class Permission extends Model
{
    ...
    public static function catalog(): array
    {
        return [
            ...
            'tankers.create' => 'Tanker ekleyebilme',
            'tankers.update' => 'Tanker düzenleyebilme',
            'tankers.delete' => 'Tanker silebilme',
            ...
            'vehicles.create' => 'Araç / makine ekleyebilme',
            'vehicles.update' => 'Araç / makine düzenleyebilme',
            'vehicles.delete' => 'Araç / makine silebilme',
            'reports.view' => 'Gelişmiş raporları görüntüleme',
            'reports.cash.pdf' => 'Kasa hareket raporu PDF alabilme',
            'reports.cash.excel' => 'Kasa hareket raporu Excel alabilme',
            'reports.fuel.pdf' => 'Yakıt raporu PDF alabilme',
            'reports.fuel.excel' => 'Yakıt raporu Excel alabilme',
